			...
			<div className="relative w-full flex flex-col items-center mb-10">
				...
				<div className="relative z-10 flex flex-col items-center justify-center h-[400px] w-full bg-black/30">
					<motion.h1
						...
						className="text-4xl md:text-5xl font-bold text-center text-white my-10"
					>
						Produtos Lasiesta
					</motion.h1>
					<motion.section
						...
						transition={{ duration: 0.8, ease: "easeOut" }}
						className="max-w-4xl px-6 text-center mb-16"
					>
						<p className="text-white leading-relaxed text-lg">
							Descubra nossa coleção única de produtos artesanais, feitos com
			...
			<section className="w-[90%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-20 mx-15">
				{filteredProducts.map((product, index) => (
					<motion.div
						...
						viewport={{ once: true }}
						className="bg-gradient-to-br from-bege-claro via-bege-escuro to-marrom-avermelhado/10 rounded-2xl shadow-lg overflow-hidden flex flex-col"
					>
						<Image
						...
						<div className="p-6 flex flex-col justify-between flex-grow bg-verde-escuro">
							<div>
								...
								<p className="text-marrom-avermelhado/80">
									{product.material}
								</p>
							</div>
